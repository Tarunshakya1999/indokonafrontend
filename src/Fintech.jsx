  ...
  return (
    <div className="indokona-page">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 text-center" data-aos="zoom-in">
              <div className="card shadow-sm p-3">
                <img src={power} alt="dashboard mockup" className="img-fluid mb-3" style={{ maxHeight: 260 }} />
        ...
        <div className="container">
          <div className="row align-items-center">
            <div className="col-md-7" data-aos="fade-right">
              ...
              <p className="text-muted">
                Don’t Just Build a Brand – Learn How to Scale It! Indokona provides not just a White Label Platform, but also marketing training programs and full automation tools.
              </p>
              <ul>
        ...
        <div className="container">
          ...
          <div className="table-responsive" data-aos="fade-up" data-aos-delay="100">
            <table className="table table-bordered mt-3">
              ...
              <tbody>
                <tr><td>Retailer</td><td>₹5,999/-</td><td>₹1,499/-</td><td>Basic Kit + Panel</td></tr>
                <tr><td>Distributor</td><td>₹19,999/-</td><td>₹4,999/-</td><td>Multi Retailer Onboarding</td></tr>
                <tr><td>Master Distributor</td><td>₹39,999/-</td><td>₹9,999/-</td><td>Manage Distributors & Retailers</td></tr>
                <tr><td>Admin Panel</td><td>Custom Pricing</td><td>As per usage</td><td>Includes advanced monitoring</td></tr>
                <tr><td>B2B API Access</td><td>Starts ₹49,999/-</td><td>As per volume</td><td>API + SaaS hosting</td></tr>
                <tr><td>White Label</td><td>₹99,999/-</td><td>₹24,999/-</td><td>Complete Brand Setup + Full Control</td></tr>
              </tbody>
            </table>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="table-responsive" data-aos="fade-up" data-aos-delay="100">
            <table className="table table-striped mt-3">
              ...
              <tbody>
                <tr><td>Direct Transactions</td><td>✅</td><td>✅</td><td>✅</td><td>✅</td><td>✅</td><td>✅</td></tr>
                <tr><td>Onboard Retailers</td><td>❌</td><td>✅</td><td>✅</td><td>✅</td><td>✅</td><td>✅</td></tr>
                <tr><td>Onboard Distributors</td><td>❌</td><td>❌</td><td>✅</td><td>✅</td><td>✅</td><td>✅</td></tr>
                <tr><td>Control Over Commission</td><td>❌</td><td>Limited</td><td>Limited</td><td>Full</td><td>Full</td><td>Full</td></tr>
                <tr><td>Branding & Domain</td><td>❌</td><td>❌</td><td>❌</td><td>❌</td><td>❌</td><td>✅</td></tr>
                <tr><td>Automation Tools Add-on</td><td>Optional</td><td>Optional</td><td>Optional</td><td>Optional</td><td>Optional</td><td>Optional</td></tr>
              </tbody>
            </table>
          </div>
        </div>
      ...
      <section className="py-5" id="faq">
        <div className="container">
          <h3 className="mb-4 text-center" data-aos="fade-up">Frequently Asked Questions</h3>
          <div className="accordion" id="faqAccordion">
            {[
              ...
              <div className="accordion-item" key={i} data-aos="fade-up" data-aos-delay={i * 100}>
