        ...
        <section className="py-24 bg-indigo-50">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              {[
                { title: 'Unified A → Z Solution', text: 'We offer genuine one-stop business transformation. From initial company registration to launching an AI-powered SaaS tool, all services are managed in-house, ensuring zero communication gaps and maximum speed.', icon: CheckCircle, aos: 'zoom-in-right' },
