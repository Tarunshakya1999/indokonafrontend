...
const MindToMarketPage = () => {
  ...
  const whatsappMessage =
    "Hello Mind To Market Team, I saw your 12 core features and want a Free Demo. Please share details and pricing for the Growth Plan.";
  ...
  const content = {
    ...
    about: {
      ...
      objectiveDesc:
        "To fully support every Entrepreneur, Startup, MSME, or Company on their entire journey from 'Idea to Empire' — from Legal setup to Global Branding.",
    },
    vision: {
      title: "Our Vision",
    ...
    features: [
      {
        title: "1. AI Branding & Identity Suite",
        icon: "fa-palette",
        color: COLORS.primary,
        description:
          "Quickly establish your professional identity. Generate logos, brand documents, and pitch decks instantly using AI-powered design tools.",
        items: [
          "AI Logo Maker & Color Psychology System",
          "Auto Visiting Card, Letterhead, ID Card Generator",
          "Brand Voice & Audio Logo Builder",
          "Auto Business Profile PDF & Pitch Deck Generator",
          "Festival Poster & Brochure Auto Generator",
          "Digital Business Card with QR Integration",
          "Brand Verification & Award Application Assistance",
        ],
      },
      {
        title: "2. Legal & Business Setup Services",
        icon: "fa-scale-balanced",
        color: COLORS.success,
        description:
          "Handle all required business registration and compliance filings. Automate legal document creation to ensure regulatory adherence.",
        items: [
          "Pvt Ltd / LLP / OPC / Proprietorship Registration",
          "MSME / ISO / GST / Trademark / FSSAI Registration",
          "ROC Compliance & Annual Filing",
          "MCA Report Management System",
          "Auto Legal Document Builder (NDA, Agreement, MoU, etc.)",
          "National & International Award Registration Support",
        ],
      },
      {
        title: "3. AI Product Creation & Market Launcher",
        icon: "fa-brain",
        color: COLORS.accent,
        description:
          "Launch products faster by automating content, pricing, and marketing assets. Create websites, funnels, and explainer videos instantly.",
        items: [
          "AI Product Name + Content + Price Generator",
          "Auto Website & Landing Page Builder",
          "Funnel Builder + E-Commerce Ready Catalog",
          "Competitor & Market Analyzer",
          "Auto Product Explainer Video Generator",
        ],
      },
      {
        title: "4. Automation & Workflow System",
        icon: "fa-robot",
        color: COLORS.info,
        description:
          "Streamline daily operations using AI bots for WhatsApp, Email, and SMS. Automate reminders, lead scoring, and invoicing.",
        items: [
          "WhatsApp AI Bot + Broadcast + CRM Integration",
          "Email, SMS & Voice Call Automation",
          "Auto Reminder, Follow-up & Lead Scoring",
          "Task & Project Workflow Management",
          "AI Business Suggestion Engine",
          "Payment Collection + Invoice Automation",
        ],
      },
      {
        title: "5. AI CRM & Business Intelligence",
        icon: "fa-chart-bar",
        color: COLORS.purple,
        description:
          "Manage leads, track sales pipelines, and forecast revenue using real-time analytics. Capture leads from all channels and use voice commands for CRM tasks.",
        items: [
          "Lead Capture from WhatsApp, Website, & Social Media",
          "Smart Pipeline with Predictive Sales Forecast",
          "Auto Quotation & Proposal Generator",
          "Employee Performance Tracker",
          "Voice-Based CRM Command",
          "Real-Time AI Analytics Dashboard",
        ],
      },
      {
        title: "6. Education & LMS System",
        icon: "fa-graduation-cap",
        color: COLORS.teal,
        description:
          "For educational businesses, automate course creation, student management, attendance, and certification processes.",
        items: [
          "Auto Course Builder with Video/Notes",
          "Student Portal + Fee + Attendance System",
          "Certificate, Hall Ticket, Result Generator",
          "Internship & Placement Tracker",
          "Webinar Integration (Zoom/Meet)",
          "AI Course Promotion Tools",
        ],
      },
      {
        title: "7. Web & App Development Studio",
        icon: "fa-globe",
        color: COLORS.secondary,
        description:
          "Get custom websites, mobile apps, SaaS platforms, and secure cloud hosting, complete with 24x7 technical support.",
        items: [
          "Custom Website, App, & Portal Development",
          "SaaS Platform Setup",
          "UI/UX Design Studio",
          "Secure Cloud Hosting (AWS / Azure)",
          "Domain + Email + SSL Setup",
          "24x7 AMC & Technical Support",
        ],
      },
      {
        title: "8. Social Media & Marketing Suite",
        icon: "fa-mobile-screen-button",
        color: COLORS.danger,
        description:
          "Automate your digital ads (Meta, Google), social posting, and content creation. Use AI for captions, reels, and SEO optimization.",
        items: [
          "AI Ad Launcher (Meta, Google, LinkedIn, YouTube)",
          "Auto Poster, Caption & Hashtag Generator",
          "WhatsApp, Instagram, Facebook Auto Scheduler",
          "Influencer & PR Collaboration Management",
          "SEO + Google Business Optimization",
          "AI Voice & Video Reel Creator",
        ],
      },
      {
        title: "9. Finance, Billing & Compliance Tools",
        icon: "fa-file-invoice-dollar",
        color: COLORS.primary,
        description:
          "Simplify financial tasks with automated billing, GST invoice generation, expense tracking, and P&L analysis.",
        items: [
          "Auto Invoice, Billing & GST Generator",
      ...
      {
        title: "10. AI Assistant & Support System",
        icon: "fa-microchip",
        color: COLORS.success,
        description:
          "Get instant, multilingual support via Voice/Text AI. Use the WhatsApp Command Center to execute business tasks instantly.",
        items: [
          "Voice & Text AI Assistant",
          "WhatsApp Command Center",
          "Auto Ticket Support System",
          "Multilingual Interface (Hindi, English, etc.)",
          "HR, Legal, Sales & Marketing AI Agents",
        ],
      },
      {
        title: "11. Verified Business Network (B2B)",
        icon: "fa-earth-africa",
        color: COLORS.info,
        description:
          "Expand your reach by listing your business, finding vendors/distributors, and participating in lead exchange with a verified network.",
        items: [
          "Verified Business Listing + Portfolio",
          "Lead Exchange & Collaboration Hub",
          "Vendor, Distributor & Franchise Finder",
          "Business Card Scan → CRM Auto Add",
          "AI SEO Optimizer + Auto Product Posting",
        ],
      },
      {
        title: "12. 24X7 Technical Support & Done-For-You Services",
        icon: "fa-handshake-angle",
        color: COLORS.purple,
        description:
          "We handle the complexity so you can focus on strategy. Get round-the-clock technical assistance and complete Done-For-You execution for all platform services.",
        items: [
    ...
    community: {
      ...
      color: COLORS.accent,
      items: [
        "Entrepreneur Community & Mentorship",
        "AI Habit Tracker + Productivity Tools",
        "Gamified Rewards & Ranking System",
        "Affiliate & Reseller Panel For Indokona Users",
  ...
  const ModuleCard = ({ icon, title, description, items, color, children }) => (
    <div className="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="100">
      ...
      >
        <h4 className="fw-bold mb-3" style={{ color: COLORS.dark }}>
          <i className={`fas ${icon} me-2`} style={{ color: color }}></i>
          {title}
        </h4>
        ...
        {/* 👉 Yahan Button / Children show hoga */}
    ...
    <div className="container-fluid p-0" style={{ scrollBehavior: "smooth" }}>
      ...
      >
        <div className="container py-5">
          <p
            className="lead text-uppercase fw-bold"
            style={{ letterSpacing: "2px", color: COLORS.accent }}
          >
            {content.header.tagline}
          </p>
          <h1 className="display-3 fw-bolder mb-4">
            {content.header.moto.split("—")[0]}
            <span style={{ color: COLORS.accent }}>
              {content.header.moto.split("—")[1]}
            </span>
          </h1>
          <p className="lead w-75 mx-auto mb-5 opacity-75">
            Your one-stop AI + SaaS Ecosystem for **Branding, Legal, Marketing,
            and Automation**—run your entire business from chat or voice
            commands.
          </p>
          <div className="d-grid gap-3 d-sm-flex justify-content-sm-center">
            <a
              href={`https://wa.me/${content.contact.phone.replace(
                /[^0-9]/g,
                ""
              )}`}
              target="_blank"
              ...
              data-aos="zoom-in"
              data-aos-delay="500" // AOS for CTA button
            >
            ...
            <button
              ...
              data-aos="zoom-in"
              data-aos-delay="600" // AOS for CTA button
            >
              🚀 Explore Pricing
            </button>
          </div>
      ...
      <section className="py-5 bg-white">
        <div className="container text-center">
          <h2 className="display-5 fw-bold mb-5" data-aos="fade-up">
            🎯 Our Core Values
          </h2>
          <div className="row">
            {/* About Us */}
            <FeatureIcon iconClass="fa-building" title={content.about.title}>
              ...
              <p className="text-dark small mt-3">
                **{content.about.objective}** {content.about.objectiveDesc}
              </p>
            </FeatureIcon>
      ...
      <section className="py-5" style={{ backgroundColor: COLORS.light }}>
        <div className="container">
          <h2 className="text-center display-5 fw-bold mb-5" data-aos="fade-up">
            ⚙ Core Features & Services (12 Modules)
          </h2>
          <p
            className="text-center lead mb-4 text-muted"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            All 12 modules are integrated into the Mind To Market™ platform for
            ...
            <div className="col-lg-10">
              <div className="row">
                {content.community.items.map((item, index) => (
                  ...
                  >
                    <div
                      className="d-flex align-items-center justify-content-start p-2 rounded"
                      style={{ backgroundColor: "rgba(255, 255, 255, 0.1)" }}
                    >
                      <i
                        className="fas fa-star me-3 fs-5"
            ...
            >
              <div
                className={`card h-100 shadow-lg ${
                  plan.isBest ? "border-primary border-3" : "border-0"
                }`}
              >
                <div
                  className={`card-header text-center ${
                    plan.isBest ? "bg-primary text-white" : "bg-light"
                  }`}
                >
                ...
                <div className="card-footer text-center">
                  <button
                    className={`btn btn-block ${
                      plan.isBest ? "btn-primary" : "btn-outline-primary"
                    } fw-bold`}
                  >
                    Select Plan
                  </button>
            ...
            <div className="col-md-6 mb-4">
              ...
              >
                {content.trustedBy.map((item, index) => (
                  <span
                    key={index}
                    className="badge bg-primary text-white fs-6 m-1 p-2 shadow-sm"
                  >
                    {item}
                  </span>
                ))}
      ...
      {/* ======================================================
            ...
            ======================================================
            */}
      <footer className="custom-footer text-white pt-5 pb-3" data-aos="fade-up">
        <div className="container">
          <div className="row align-items-start">
            {/* Contact Info */}
            <div className="col-lg-4 mb-4 footer-box" data-aos="fade-right">
              ...
              <p className="footer-item">
                ...
                <a
                  href={`http://${content.contact.website}`}
                  className="footer-link"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <p className="footer-item">
                ...
                {content.contact.headOffice}
              </p>
            </div>

            {/* Quick Links */}
            <div className="col-lg-2 mb-4 footer-box" data-aos="fade-up">
              <h5 className="fw-bold footer-heading">🔗 Quick Links</h5>

              <ul className="list-unstyled footer-links-list">
                <li>
                  <Link className="footer-link" to="/t&c">
                    Terms & Conditions
                  </Link>
                </li>
                <li>
                  <Link className="footer-link" to="/pp">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link className="footer-link" to="/rp">
                    Refund Policy
                  </Link>
                </li>
              </ul>
            ...
            {/* Legal Notes */}
            <div className="col-lg-6 mb-4 footer-box" data-aos="fade-left">
              <h5 className="fw-bold footer-heading">
                ⚖ {content.legal.title}
              </h5>

              <ul className="list-unstyled">
                {content.legal.notes.map((note, i) => (
                  <li key={i} className="text-white-50 footer-legal-line">
                    • {note}
                  </li>
                ))}
              </ul>
          ...
          <div className="text-center pb-2">
            <small className="footer-bottom-text">
              © {new Date().getFullYear()} Mind To Market™ — All rights
              reserved.
            </small>
          </div>
        </div>
