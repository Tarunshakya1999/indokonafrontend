              ...
              <div className="col-md-4 mb-4" key={index}>
                ...
                >
                  ...
                  <div className="card-body text-center">
                    ...
                    {/* MSME Button Only for 2nd Module (index === 1) */}
                    {index === 1 && (
                      <Link
                        to="/msmeform"
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-4 mb-4">
              ...
              <p className="mb-1">
                <i className="fas fa-envelope me-2 text-warning"></i> Email:{" "}
                <a
              ...
              <p className="mb-1">
                <i className="fab fa-whatsapp me-2 text-warning"></i> Phone /
                WhatsApp:{" "}
                <a
                  href={`https://wa.me/${content.contact.phone.replace(
                    /[^0-9]/g,
              ...
              <p className="mb-1">
                <i className="fas fa-globe me-2 text-warning"></i> Website:{" "}
                <a
              ...
              <p>
                <i className="fas fa-map-marker-alt me-2 text-warning"></i> Head
                Office: {content.contact.headOffice}
              </p>
            </div>
          ...
          <div className="text-center pb-2">
            <small>
              &copy; {new Date().getFullYear()} Mind To Market™. All rights
              reserved.
            </small>
          </div>
        </div>
