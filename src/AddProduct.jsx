        ...
        <Container className="mt-5 p-4 bg-light rounded shadow">
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" name="productdescription" value={formData.productdescription} onChange={handleChange} required />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Price</Form.Label>
              <Form.Control type="number" name="productprice" value={formData.productprice} onChange={handleChange} required />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Discounted Price</Form.Label>
              <Form.Control type="number" name="productdiscounted_price" value={formData.productdiscounted_price} onChange={handleChange} required />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Rating</Form.Label>
              <Form.Control type="number" name="productrating" value={formData.productrating} onChange={handleChange} />
            </Form.Group>
            ...
            <div className="text-center">
              <Button type="submit" className="mt-2 px-4">Add Product</Button>
            </div>
          </Form>
        </Container>
      </div>
