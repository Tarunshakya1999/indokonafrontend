        ...
        <div style={{ minHeight: "100vh", backgroundColor: "#f0f2f5" }}>
          ...
          <nav
            ...
            style={{
              ...
              marginLeft: window.innerWidth > 768 ? (open ? 230 : 70) : 0,
              width: window.innerWidth > 768 ? `calc(100% - ${open ? 230 : 70}px)` : '100%',
              transition: "0.3s",
            }}
          >
            <div className="container-fluid px-3">
              ...
              <button
                className="btn btn-sm btn-outline-primary d-md-none me-2"
          ...
          {/* FOOTER */}
          <footer
            className="footer text-center text-muted py-3"
            style={{
